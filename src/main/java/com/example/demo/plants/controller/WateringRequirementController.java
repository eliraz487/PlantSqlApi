...
import com.example.demo.plants.service.WateringRequirementService;
import com.example.demo.plants.vo.WateringRequirementVO;
...
public class WateringRequirementController {
    ...
    public String update(@Valid @NotNull@RequestParam Long id,
        ...
        return wateringRequirementService.update(id, vO);
    }
